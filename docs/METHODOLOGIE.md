...
**Non encore couverts** (liste candidats REFLEXIONCLAUDE) : `pocket_tts`
(Kyutai), `cosyvoice3_05b` (Fun-CosyVoice3-0.5B-2512), `audio8_06b`,
`parler_tts_fr`. Références qualité non commerciales (dans `models.lock`,
phase `ref`, non tournées) : `xtts_v2` (CPML), `f5_tts` (CC-BY-NC).
Baseline CPU `Piper` : envisagée, non faite.
